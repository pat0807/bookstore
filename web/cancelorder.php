<!-- <?php
      ...
      if (isset($_POST["action"]) && ($_POST["action"] == "delete")) {
        ...
        $sql_query = "UPDATE orders SET status=-1 WHERE id=?";
...
<body>
  ...
  <form action="" method="post" name="formDel" id="formDel">
    <table border="2" align="center" cellpadding="4">
      <tr>
        <th>
          <font color="white">欄位</font>
        </th>
        <th>
          <font color="white">資料</font>
        </th>
      </tr>
      <tr>
        <td>
        ...
        <td>
          <font color="white"><?php echo $member_id; ?></font>
        </td>
      </tr>
      <tr>
        <td>
        ...
        <td>
          <font color="white"><?php echo $cardholder_name; ?></font>
        </td>
      </tr>
      <tr>
        <td>
        ...
        <td>
          <font color="white"><?php echo $card_number; ?></font>
        </td>
      </tr>
      <tr>
        <td>
        ...
        <td>
          <font color="white"><?php echo $inform; ?></font>
        </td>
      </tr>
      <tr>
        <td>
        ...
        <td>
          <font color="white"><?php echo $total; ?></font>
        </td>
      </tr>
      <tr>
        <td>
        ...
        <td>
          <font color="white"><?php echo $order_time; ?></font>
        </td>
      </tr>
